...
export default function CarouselMovieContent({ movie }: Props) {
  return (
    <div className="relative w-full h-[600] text-white">
      <img
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-10 max-w-xl">
        ...
        <button className="w-fit px-4 py-2 bg-white text-black rounded hover:bg-gray-200 transition">
          ▶ Watch Trailer
        </button>
      </div>
    </div>
